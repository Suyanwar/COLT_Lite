...
<?php $this->load->view('header');?>
    <div style="margin-top: 70px; padding: 30px;">
        ...
        <div class="row">
            <div class="col-lg-4" id="effective_communication" style="cursor: pointer;">
                <div class="panel panel-color panel-pink">
                    <div class="panel-heading">
                        <h3 class="panel-title">Effective Communication</h3>
                    </div>
                    <div class="panel-body">
                        <p>Berisikan data mengenai tabel komunikasi yang efektif.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4" id="highlight" style="cursor: pointer;">
                <div class="panel panel-color panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Highlight</h3>
                    </div>
                    <div class="panel-body">
                        <p>Berisikan jumlah pertumbuhan <i>fans</i> pada periode saat ini.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4" id="benchmark" style="cursor: pointer;">
                <div class="panel panel-color panel-danger">
                    <div class="panel-heading">
                        <h3 class="panel-title">Benchmark</h3>
                    </div>
                    <div class="panel-body">
                        <p>Berisikan data akun facebook terdaftar yang di dapatkan berdasarkan kategori.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4" id="performance" style="cursor: pointer;">
                <div class="panel panel-purple">
                    <div class="panel-heading">
                        <h3 class="panel-title">Performance</h3>
                    </div>
                    <div class="panel-body">
                        <p>Perbandingan <i>fans</i> antara <i>account</i> dengan kompetitor.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4" id="fans_connect" style="cursor: pointer;">
                <div class="panel panel-color panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">Fans Connect</h3>
                    </div>
                    <div class="panel-body">
                        <p>...</p>
                    </div>
...
$(function() {
    $(".col-lg-4").click(function(event){ 
        ...
        report_load('facebook', $parent.prop('id'), <?php echo $account_id;?>, prev_month());
    });
